 ...
 */
@Slf4j
public class CollectionStreamTest extends TestCase {
    ...
    public void testApp() {
        ...
        Person p4 = new Person("d", 15, "ddd");
        list = Arrays.asList(p1, p2, p3, p4);

        list = list.stream().filter(person -> (person.getAge() > 11 && "d".equals(person.getName())))
